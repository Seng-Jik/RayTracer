...
let hitableList : (IHitable*IMaterial) list = [
    ...
    (Sphere(Vec3(1.0,0.0,-1.0),0.5) :> IHitable,LambertianMetal(Vec3(1.0,1.0,1.0),5.0) :> IMaterial)
    (Sphere(Vec3(-1.0,0.0,-1.0),0.5) :> IHitable,LambertianMetal(Vec3(0.8,0.6,0.2),0.3) :> IMaterial)
